...
import { classifyFieldSemanticRole, isNegatedContext } from '../src/visual-translation/v2/runtime/field-semantic-role.js';
import { evaluateAssetAuthorization } from '../src/visual-translation/v2/runtime/asset-authorization-evaluator.js';
import { evaluateSpatialDrift } from '../src/visual-translation/v2/runtime/spatial-drift-evaluator.js';
import { detectUnexpectedBrandNames, normalizeBrandCandidate } from '../src/visual-translation/v2/runtime/brand-identity-preservation-evaluator.js';
import { evaluateExecutionExampleCompleteness, hasMeaningfulValue } from '../src/visual-translation/v2/runtime/execution-example-completeness-evaluator.js';
import { evaluateDirectionFamilyDifference } from '../src/visual-translation/v2/runtime/direction-family-difference-evaluator.js';
import { aggregateGateIssues } from '../src/visual-translation/v2/runtime/gate-issue-aggregator.js';
import { compileExecutionDirectionV2 } from '../src/visual-translation/v2/runtime/compile-execution-direction-v2.js';
import { compileExecutionDirectionsAuditV2, compileExecutionDirectionsReportV2 } from '../src/visual-translation/v2/report/visual-directions-report-compiler.js';
import { buildExecutionDirectionV2Prompt } from '../src/visual-translation/v2/prompts/direction-generation-prompt-v2.js';

const fixtureRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), '..', 'fixtures', 'visual-direction-v2', 'jiuzhou-meixue');
