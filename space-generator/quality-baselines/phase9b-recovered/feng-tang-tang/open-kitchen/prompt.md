...
Scene: `open-kitchen` / entrance_view.
Task: 生成冯烫烫开放厨房作为视觉锚点，厨师动作可见，餐桌围绕。
Aspect ratio: 16:9.
...
**Building DNA**:
- Spatial organization: 点餐区 -> 明档制作区 -> 取餐区 -> 就餐区；外带包装区独立设置；点餐；取餐；堂食
- Functional network nodes: 点餐区 -> 明档制作区 -> 取餐区 -> 就餐区；外带包装区独立设置
- Program nodes: 点餐；取餐；堂食；外带；明档展示
...
- **浅色木材**: 温暖触感；自然纹理
  ...
  avoid: 深色沉重木材；高光烤漆木
- **红色金属/塑料**: 高反射（金属）；哑光（塑料）
  brand role: 品牌色载体，用于招牌、装饰件、灯笼
  avoid: 暗红色；粉紅色
- **浅色石材/瓷砖**: 耐用；易清洁；漫反射
