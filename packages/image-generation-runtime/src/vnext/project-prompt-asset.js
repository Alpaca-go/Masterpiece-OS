export function validateVNextProjectPromptAsset(asset, projectId, deliverableFamily) {
  const errors = [];
...
export function assertVNextProjectPromptAsset(asset, projectId, deliverableFamily) {
  const result = validateVNextProjectPromptAsset(asset, projectId, deliverableFamily);
