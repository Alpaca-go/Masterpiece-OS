...
Scene: `corridor` (transition_corridor).
...
**Required Zones**: circulation_path
**Optional Zones**: wall_art, lighting_feature
...
**Camera**: lens=normal | height=human_eye_level | distortion=controlled
