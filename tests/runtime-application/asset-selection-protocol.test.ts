...
} from '@masterpiece/runtime-core/application/asset-selection-protocol/index.ts';
import { buildReferenceAssetSelectionPrompt } from '@masterpiece/runtime-core/application/asset-selection-protocol/prompts.ts';
import type {
