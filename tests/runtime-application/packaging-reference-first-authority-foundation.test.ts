...
test('AJ-20 P3-B accepted semantics are unchanged', () => assert.equal(git(['diff', '--name-only', P3B_ACCEPTED, 'HEAD', '--', 'apps/web/src/features/packaging', 'apps/web-runtime/src/current-operation-graph.ts', 'packages/runtime-core/src/operations/packaging-operations.js', 'packages/runtime-core/src/application/packaging']), ''));
