...
test('Node Runtime Host binds all 206 channels to the Shared Registry without Electron', async (t) => {
  ...
  // R6 adds five narrow designer-driven correction operations to the 201-channel R5 baseline.
  assert.equal(host.operationCount, 206);
