...
> Learn composition, spatial grammar, lighting language, and material language from the reference image as DESIGN MECHANISM (当前 brand: yi-ji-liang-fang) (当前 industry: 中医养生与健康管理).
