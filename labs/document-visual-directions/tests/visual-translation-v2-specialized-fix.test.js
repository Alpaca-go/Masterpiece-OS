...
import { validateExecutionDirectionV2, VISUAL_DIRECTION_V2_CONTRACT_VERSION } from '../src/visual-translation/v2/schemas/direction-contract-v2.js';
import { evaluateExecutionReadiness } from '../src/visual-translation/v2/runtime/execution-readiness-evaluator.js';
import { detectUnexpectedBrandNames, evaluateBrandIdentityPreservation } from '../src/visual-translation/v2/runtime/brand-identity-preservation-evaluator.js';
import { evaluateBusinessModelCoverage } from '../src/visual-translation/v2/runtime/business-model-coverage-evaluator.js';
import { evaluateDirectionFamilyDifference } from '../src/visual-translation/v2/runtime/direction-family-difference-evaluator.js';
import { evaluateComplianceWeight } from '../src/visual-translation/v2/runtime/compliance-weight-controller.js';
import { evaluateIndustryRecognitionCoverage } from '../src/visual-translation/v2/runtime/industry-recognition-classifier.js';
import { evaluateAssetAuthorizationSet } from '../src/visual-translation/v2/runtime/asset-authorization-evaluator.js';
