...
if (-not (Test-Path $target)) {
  Copy-Item 'D:\Masterpiece-OS\space-generator\v1-experimental\architecture-anchors\jiuzhou-aesthetics\JZMX-ARCH-01.png' $target
}
```
...
`D:\Masterpiece-OS\space-generator\v1-experimental\validation-results\spatial-preset-validation\jiuzhou-aesthetics\<preset>\`:
