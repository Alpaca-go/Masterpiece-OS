...
import type { CreativeDirectionSession, FinalCreativeDirection, SharedProjectContext } from './creative-direction-contracts.ts';
...
export function createCreativeDirectionStore(options: { readDefaultDataPath: () => string | Promise<string> }) {
  ...
  return Object.freeze({
    ...
    async getFinal(id: string) { return readJson<FinalCreativeDirection>((await paths(id)).final); },
