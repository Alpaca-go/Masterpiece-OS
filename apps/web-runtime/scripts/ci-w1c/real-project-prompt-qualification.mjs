...
function buildStrategicPrompt(ctx) {
  ...
  const userMessage = [
    ...
    '  2. tensions (2-5; poleA, poleB, whyItMatters, factRefs, needRefs, evidenceRefs)',
    '  3. insights (3-6; statement, implication, whyThisProject, factRefs, needRefs, evidenceRefs)',
    '  4. opportunities (3-5; thesis, strategicMechanism, whyThisProject, risk, insightRefs, factRefs)',
    '',
    '# OUTPUT JSON SCHEMA',
...
function buildConceptPrompt(ctx, synthesis) {
  ...
  const userMessage = [
    ...
    '',
    '# TASK',
    'Produce 3-5 ModelAssistedConceptCandidate entries. Each must contain:',
