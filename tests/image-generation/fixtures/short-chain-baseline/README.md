# vNext image-generation baseline

This directory freezes the pre-vNext comparison set without committing client
...
`vnext`; Phase 5 is responsible for changing the default only after regression
checks pass.
