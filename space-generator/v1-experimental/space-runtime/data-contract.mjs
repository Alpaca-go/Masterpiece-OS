...
export function getBrandDnaPaths(brandKey) {
  const dnaMap = {
    ...
    'yi-ji-liang-fang': 'test-cases/regression/projects/yi-ji-liang-fang.dna.json',
    'wa-ye': 'test-cases/regression/projects/wa-ye.dna.json',
    'jin-xiu': 'test-cases/regression/projects/jin-xiu.dna.json',
  };
  const spatialIntentMap = {
    ...
    'jin-xiu': 'field-schema/examples/jin-xiu.spatial-intent.json',
  };
  const spatialRealityMap = {
    ...
    'jin-xiu': 'spatial-reality/examples/jin-xiu.spatial-reality.json',
  };
  const architecturePreservationMap = {
    ...
    'jin-xiu': 'architecture-preservation/examples/jin-xiu.architecture-preservation.json',
  };
