...
Generator still passes after every P1â€“P4 commit. This is the
hard gate that P3 / P4 will re-run before declaring any
Packaging milestone PASS.

## 2. Hard gate (run before / after every P1â€“P4 commit)
...
If any command fails: stop. The P1â€“P4 commit is NOT allowed to
...
A **decrease** in any count is a Space regression. P1â€“P4 must
...
`tests/image-generation/`. P0 lists them so P1â€“P4 can diff
easily.
...
(A4 FROZEN). P1â€“P4 must keep them all PASS.
...
## 5. New tests P1â€“P4 must add (per spec)

Per the spec, P1â€“P4 each introduce new tests. P0 records what
...
- [x] New tests P1â€“P4 must add enumerated
