...
> Learn composition, spatial grammar, lighting language, and material language from the reference image as DESIGN MECHANISM (当前 brand: feng-tang-tang) (当前 industry: 餐饮 / 川菜 / 跷脚牛肉).
