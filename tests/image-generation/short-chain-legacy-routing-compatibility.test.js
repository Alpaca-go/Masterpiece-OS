...
// This test freezes the registered legacy routing and prompt compatibility shape.
...
test('pipeline compatibility keeps current default with an explicit legacy rollback', () => {
...
test('legacy routing regression keeps routing, project identity, prompt budget, and compile latency', async () => {
...
test('legacy routing implementation has no analysis-report or execution-document dependency', async () => {
