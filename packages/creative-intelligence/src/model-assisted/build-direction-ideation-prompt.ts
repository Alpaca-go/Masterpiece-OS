...
export function buildDirectionIdeationPrompt(input: DirectionIdeationPromptInput): DirectionIdeationPromptOutput {
  ...
  const userMessage = [
    ...
    'directions[i].conceptRefs MUST reference concept IDs (either the ones the concept stage wrote, or the auto-assigned "concept-ma-0" / "concept-ma-1" / ...).',
    ...
    'Do NOT put concept / opportunity / insight statement text in any refs field — only IDs.',
    'If you assign your own IDs, make sure they are stable strings the upstream concept set actually used.',
    '',
