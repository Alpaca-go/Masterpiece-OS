...
// These tests assert the registered legacy routing compatibility mode.
...
test('short-chain contract locks the requested deliverable in a Task Contract', () => {
...
test('short-chain contract routes reception space only through space templates', () => {
...
test('short-chain contract public templates contain no project-specific aesthetic answer', () => {
