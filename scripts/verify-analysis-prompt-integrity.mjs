...
if (violations.length > 0) {
  console.error(`[verify-analysis-prompt-integrity] FAIL — ${violations.length} violation(s) detected.`);
  process.exit(1);
}
console.log(`[verify-analysis-prompt-integrity] PASS — ${Object.keys(FROZEN_DIGESTS).length} frozen digests verified, 0 drift.`);
