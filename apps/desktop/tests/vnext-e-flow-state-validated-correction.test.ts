...
import type { ImageGenerationRun } from '../src/shared/types.ts';
import type { VNextGenerationFlowState } from '../src/shared/types.ts';
...
async function compileOnce(service: ReturnType<typeof createVNextImageGenerationService>) {
...
test('E-2: 6 flowState values are valid (no orphan states)', () => {
  ...
  const allowed: VNextGenerationFlowState[] = [
    'initial_failed',
    'awaiting_validation',
    'correcting',
