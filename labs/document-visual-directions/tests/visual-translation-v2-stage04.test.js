...
import { getStageProfile, STAGE_PROFILES } from '../src/visual-translation/v1/protocol/stage-registry.js';
import { resolveMaxOutputTokens, planTruncationRetry, getModelCapabilities } from '../src/adapters/model-capabilities.js';
import { estimateStage04V2OutputBudget, outputUtilization } from '../src/visual-translation/v2/runtime/output-budget.js';
import { prepareDocumentSet } from '../src/shared/analysis/document-preparation.js';
import { valueHash } from '../src/shared/analysis/checkpoint-store.js';
import { validateVisualEvidenceMap } from '../src/visual-translation/v1/schemas/visual-evidence-map-v1.js';
import { validateVisualStrategySignalMap } from '../src/visual-translation/v1/schemas/visual-strategy-signal-map-v1.js';
import { validateVisualOpportunityMap } from '../src/visual-translation/v1/schemas/visual-opportunity-map-v1.js';
import { buildVisualTranslationCheckpoint } from '../src/visual-translation/v1/runtime/visual-translation-checkpoint-store.js';
import { VISUAL_EVIDENCE_PROMPT_VERSION } from '../src/visual-translation/v1/prompts/visual-evidence-prompt-v1.js';
import { VISUAL_SIGNAL_OPPORTUNITY_PROMPT_VERSION } from '../src/visual-translation/v1/prompts/visual-signal-opportunity-prompt-v1.js';
import { runVisualTranslationV2 } from '../src/visual-translation/v2/runtime/run-visual-translation-v2.js';
