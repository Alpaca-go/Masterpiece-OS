...
if (violations.length > 0) {
  console.error(`[verify-a4-legacy-desktop] FAIL — ${violations.length} violation(s) detected.`);
  process.exit(1);
}
console.log(`[verify-a4-legacy-desktop] PASS — scanned ${pathScanned} tracked directories + package.jsons + runtime entrypoints, 0 Desktop / Electron returns.`);
