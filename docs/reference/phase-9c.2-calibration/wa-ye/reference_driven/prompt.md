...
> Learn composition, spatial grammar, lighting language, and material language from the reference image as DESIGN MECHANISM (当前 brand: wa-ye) (当前 industry: 餐饮 / 炭烧牛蛙 / 潮流快餐).
