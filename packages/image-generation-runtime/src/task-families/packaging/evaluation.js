...
export function evaluatePackagingEvidence(input = {}) {
  ...
  const criteria = [
    ...
    criterion('craft', evidence.craftMatch === true, null, 'requested_finishing_process_must_match'),
    criterion('asset_ownership', evidence.assetOwnershipMatch === true, null,
      'package_graphics_must_stay_on_package_surfaces'),
