...
Scene: `vip_lounge` (private_vip_lounge).
Context: flagship | Scale: medium.
...
**Required Zones**: lounge_seating, tea_table, natural_lighting
**Optional Zones**: art_installation
