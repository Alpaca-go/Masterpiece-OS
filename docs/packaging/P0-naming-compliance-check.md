...
|---|---|---|
| `R8.6` / `R9` / `R10` / `R11` / `R11.2` etc. | `tests/image-generation/space-r*.test.js` filenames + golden baseline directories (`space-generator/quality-baselines/r8.6-…`) | KEEP (historical compatibility; outside P0 scope) |
| `phase9b-recovered` | `space-generator/quality-baselines/phase9b-recovered/` | KEEP |
