...
} from '@masterpiece/runtime-core/application/reference-style-reconstruction.ts';
import {
  recoverPersistedProjectIdentity,
  resolveAnalyzedProjectIdentity
} from '@masterpiece/runtime-core/application/project-identity.ts';
import type { ProjectRecord, ReferenceTranslationProfile } from '@masterpiece/runtime-core/application-contracts.ts';
