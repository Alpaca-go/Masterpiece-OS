...
test('deliverable evidence classifies a VI board returned for a space task as a hard mismatch', () => {
...
test('deliverable evidence refuses to self-certify an output without visible image evidence', () => {
  const validation = validateShortChainDeliverableEvidence({
    projectId: 'project-1',
    taskContract,
    runId: 'run-1',
...
test('deliverable evidence correction preserves the original prompt and adds one repair block', () => {
  const validation = validateShortChainDeliverableEvidence({
    projectId: 'project-1',
    taskContract,
    runId: 'run-1',
