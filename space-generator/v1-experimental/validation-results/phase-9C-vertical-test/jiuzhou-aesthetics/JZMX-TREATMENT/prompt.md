...
Scene: `treatment` (treatment_room).
Context: flagship | Scale: small.
...
## Anchor 1: JZMX-ARCH-03-ConsultationFacade (role=wide_consultation_floor_with_full_glass)
...
## Anchor 3: JZMX-ARCH-01-ReceptionMembrane (role=interior_reception_with_membrane_ceiling)
...
**Required Zones**: treatment_bed, medical_equipment, wash_station
**Optional Zones**: natural_lighting
