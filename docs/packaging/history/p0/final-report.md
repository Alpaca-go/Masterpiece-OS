...
|---|---|---|---|
| 1 | Packaging Architecture Map | `../architecture-map.md` | FROZEN |
| 2 | Shared vs Target-Specific Matrix | `../shared-vs-target-matrix.md` | FROZEN |
| 3 | Packaging Target Interface | `../packaging-target-interface.md` | FROZEN |
| 4 | Packaging Domain Schema | `../domain-schema.md` | FROZEN |
| 5 | Reuse Decision Log | `../reuse-decision-log.md` | FROZEN |
| 6 | Space Regression Checklist | `../space-regression-checklist.md` | FROZEN |
| 7 | Naming Compliance Check | `../naming-compliance-check.md` | FROZEN |
| �?| Spec reference copy | `spec.md` | FROZEN |
...
pipelines. (See `../reuse-decision-log.md` §3.)
...
`../naming-compliance-check.md`) and out of P0 scope.
...
|---|---|
| 不复�?Space runtime | PASS �?every Packaging layer is REUSE/REUSE+ADAPT |
...
| Space regression 有明确测试路�?| PASS �?`../space-regression-checklist.md` lists hard gate + per-phase test inventory |
...
- Confirm the color baseline (珍珠�?65-70% / 矿物�?20-25% / 石墨�?5-10% / 虹彩蓝紫仅局部高�? is the 九州美学 baseline.
- Confirm the forbidden-motif list (大面积浓�?/ 大面积写实羽�?/ 夜店式虹�? is correct.
