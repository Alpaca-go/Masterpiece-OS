...
import { adaptSpaceSource, SPACE_QUALITY_SOURCE_ADAPTER_VERSION } from './source-adapter.js';
import {
 ...
 */
export function compileSpacePrompt(input) {
  const layers = adaptSpaceSource(input);
