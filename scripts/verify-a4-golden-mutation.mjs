...
if (violations.length > 0) {
  console.error(`[verify-a4-golden-mutation] FAIL — ${violations.length} violation(s) detected.`);
  process.exit(1);
}
console.log(`[verify-a4-golden-mutation] PASS — ${Object.keys(FROZEN_DIGESTS).length} Golden fixtures verified, 0 drift.`);
