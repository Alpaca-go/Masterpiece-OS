...
if (violations.length > 0) {
  console.error(`[verify-secret-safety] FAIL — ${violations.length} violation(s) detected.`);
  process.exit(1);
}
console.log(`[verify-secret-safety] PASS — scanned ${scanned} tracked files, 0 secret-shape matches.`);
