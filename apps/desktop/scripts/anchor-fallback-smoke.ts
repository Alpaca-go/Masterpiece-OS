...
// This script will be compiled and run by Electron
...
async function callSeedreamApi(apiKey: string, prompt: string, referenceImages: string[] = []): Promise<any> {
...
async function saveGeneratedImage(responseData: any, outputPath: string): Promise<number> {
