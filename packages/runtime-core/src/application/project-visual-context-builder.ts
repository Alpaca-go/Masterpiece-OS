...
export interface BuildProjectVisualContextInput {
...
function mergePromptSourceObject(
  ...
  const migrated = migrateProjectVisualContext(context).promptSourceObject;
 ...
 */
export function migrateProjectVisualContext(
  context: ProjectVisualContextShortChain,
 ...
 */
export function buildProjectVisualContext(
  input: BuildProjectVisualContextInput,
): ProjectVisualContextShortChain {
  const { project } = input;
  ...
  const migrated = migrateProjectVisualContext(context);
  return {
    ...migrated,
...
export function validateProjectVisualContext(
  value: unknown,
